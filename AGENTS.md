...
- **Agent changes MUST follow the CLAUDE.md "Agent change workflow"** — branch, commit individually, present for review, squash before merge, delete the local feature branch once merged. Never push to target branches directly, never push feature branches, never comment on or close issues without asking.
